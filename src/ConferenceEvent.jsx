...
const ConferenceEvent = () => {
    ...
    const avItems = useSelector((state) => state.av);// display the details of the add-ons 
    ...
    const avTotalCost = calculateTotalCost("av");//he total cost of the "add-ons" section is stored in the constant avTotalCost
